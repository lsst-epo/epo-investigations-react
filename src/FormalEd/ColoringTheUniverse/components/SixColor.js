      ...
      <div className="widget container">
        <div className="row">
          ...
          <div className="col-8">
            ...
            {this.state.checked ? (
              <div className="image_filter u_filter" />
            ) : null}
            <div className="image_filter g_filter" />
            <div className="image_filter r_filter" />
            <div className="image_filter i_filter" />
            <div className="image_filter z_filter" />
            <div className="image_filter y_filter" />
          </div>
        </div>
